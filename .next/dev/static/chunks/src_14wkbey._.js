...
_s(Home, "pVnx9gG4ILpwNypjZL8coK6lX6I=");
_c = Home;
var _c;
...
const NoteForm = ({ onClose })=>{
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        if (!content.trim() || !__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"]) return;
        setIsSubmitting(true);
        try {
            const finalAuthor = author.trim() || "Anonymous";
            // 1. Save to Supabase
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('notes').insert([
                {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$telegram$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendTelegramNotification"])(content.trim(), finalAuthor).catch(console.error);
        } catch (error) {
...
_s(NoteForm, "TmMYKdKcznYUf40hqW8C/n4cEVg=");
_c = NoteForm;
var _c;
...
//# sourceMappingURL=src_14wkbey._.js.map